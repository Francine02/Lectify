        ...
        <div className="grid sm:grid-cols-3 py-10 space-y-6 justify-center">
          ...
          <div>
            ...
            <p
              ...
              className="cursor-pointer text-center text-[0.8rem] sm:text-[1rem] font-semibold text-text pt-3 hover:opacity-75"
            >
              {t('footer.docs')}
            </p>
            <Links
              link="https://github.com/Francine02/Lectify"
              text={`Frontend ${t('footer.code')}`}
            />
            <Links
              link="https://github.com/id0ubl3g/lectify-flask-api"
              text={`Backend ${t('footer.code')}`}
            />
          </div>
          ...
          <div>
            ...
            <Links
              link="https://github.com/Francine02"
            ...
            />
            <Links
              link="https://github.com/id0ubl3g"
              img="/assets/Icon-github.png"
              text="George Victor"
            />
            <Links
              link="https://www.linkedin.com/in/id0ubl3g"
              img="/assets/Icon-linkedin.png"
              text="George Victor"
            />
          </div>
        </div>
        <p className="text-secondary-phone text-center pb-4 pt-5 border-t border-[#c7c7c7]">
          © 2025 Lectify. {t('footer.license')}
        </p>
      </footer>
    </>
  );
