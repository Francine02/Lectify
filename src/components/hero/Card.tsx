...
export function Card({ text, img }: ImagTitleProps) {
    return (
        <button className="pt-5 grid items-center justify-center hover:brightness-[96%] cursor-pointer transition duration-100 ease-in-out m-auto sm:m-0">
