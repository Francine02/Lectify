...
export function Title({ title, emphasis, titleContinuation }: TitleProps) {
    return (
        <h1 className="text-title-phone sm:text-title-tablet md:text-title-md lg:text-title-lg 2xl:text-title-2x1 text-center font-black text-text drop-shadow-xl">
            {title}
