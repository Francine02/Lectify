import { RadioPros } from "@/components/summary/radio/RadioProps";
    ...
    <div className="flex items-center justify-center my-2 sm:my-0">
      ...
      >
        <input
          ...
          id={value}
        />
        <span className="absolute bg-slate-800 w-3 h-3 rounded-full opacity-0 peer-checked:opacity-100 transition-opacity duration-200 top-1/2 left-1/2 transformm -translate-x-1/2 -translate-y-1/2"></span>
      </label>
